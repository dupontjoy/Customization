...
:xyr
xcopy "%SoftDir%\Microsoft\NewPC-Settings\xyr系统优化\Config\[Clean]Cing's Settings.ini" "%OutputDir%\Customization\Software\xyr系统优化\"  /s /y /i
xcopy "%SoftDir%\Microsoft\NewPC-Settings\xyr系统优化\Config\[Optimization]Cing's Settings.ini" "%OutputDir%\Customization\Software\xyr系统优化\"  /s /y /i
