...
:LXmusicDesktop
xcopy "%BackupDir%\..\..\..\lx-music-desktop\updateLXmusicDesktop.cmd" "%SyncDir%\PSoftware\LXmusic\" /y
robocopy "C:\Users\%USERNAME%\AppData\Roaming\lx-music-desktop\LxDatas" "%SyncDir%\PSoftware\LXmusic\LxDatas" /MIR /ZB /R:3 /W:5
...
:v2rayN（VRN）
robocopy "%BackupDir%\..\..\Software\v2rayN\guiConfigs" "%SyncDir%\PSoftware\VRN\guiConfigs" /MIR /ZB /R:3 /W:5
